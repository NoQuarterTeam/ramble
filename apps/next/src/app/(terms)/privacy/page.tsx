    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          use it. By signing up and using our platform, you agree to the terms of this Privacy Policy.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <ul>
          <li>
            Email address: We collect your email address to create and manage your account, and to communicate important updates
            and notifications to you.
          </li>
          <li>Password: To secure your account, we collect a password that you create during the signup process.</li>
          <li>
            Username, First Name, and Last Name: These details are collected to personalize your experience on our platform and
            enable interactions with other users.
          </li>
          <li>
            Lists and Spots: We collect the lists you create and the spots you save in order to provide you with the desired
            features and functionality of our platform.
          </li>
          <li>Images: Adding a profile avatar, images for spots, and images for vans associated with your profile.</li>
        </ul>
      </div>
      <div className="space-y-2">
        ...
        <ul>
          <li>
            Providing and improving our platform: Your information allows us to deliver the services and features you expect and
            enhance your overall experience.
          </li>
          <li>
            Communication: We may use your email address to send you administrative notifications, updates, and relevant
            information.
          </li>
          <li>
            Personalization: Your username, first name, and last name may be displayed to other users to enable interactions and
            foster a community within our platform.
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-2">
        ...
        <ul>
          <li>
            With other users: Your username and public information may be visible to other users when interacting within the
            platform.
          </li>
          <li>
            Aggregated and anonymized data: We may share aggregated and anonymized data that does not personally identify you for
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          will retain your personal information for as long as necessary to fulfill the purposes outlined in this Privacy Policy,
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          accessing their websites or using their services.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          us and will always strive to handle your personal information with care and respect.
        </p>
      </div>
    </div>
  )
