...
export function Nav() {
  ...
  return (
    <div className="h-nav fixed left-0 top-0 z-10 flex w-full items-center justify-between border-b border-solid border-gray-50 bg-white px-4 align-middle dark:border-gray-700 dark:bg-gray-800 xl:px-12">
