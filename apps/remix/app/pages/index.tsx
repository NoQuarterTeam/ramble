  ...
  return (
    <PageContainer>
      ...
      <div className="max-w-3xl space-y-4 pb-40">
        ...
        <p>
          Ramble is more than just a platform for finding camper spots. It's a comprehensive guide to nomadic life, designed with
          remote workers, travellers, and outdoor sports enthusiasts in mind. Whether you're a climber, mountain biker, SUP-er, or
          just someone who loves exploring new places, Ramble has something for you.
        </p>
      </div>
