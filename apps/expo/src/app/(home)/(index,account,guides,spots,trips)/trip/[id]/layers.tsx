...
import { CloudRain, Earth, MountainSnow, SunMoon, Thermometer } from "lucide-react-native"
...
export const useMapLayers = create<{
  ...
  persist(
    ...
    { name: "ramble.trips.map.layers", storage: createJSONStorage(() => AsyncStorage) },
  ),
)
...
export default function MapLayers() {
  ...
  const onSetMapLayer = (layer: MapLayerOptions["layer"]) => {
    ...
    posthog.capture("trip map layer changed", { layer })
  }
