...
export default function NewSpotLocationScreen() {
  ...
  const [activeGooglePlace, setActiveGooglePlace] = React.useState<RouterOutputs["google"]["getPlacesInBounds"][number]>()
...
interface Props {
  place: RouterOutputs["google"]["getPlacesInBounds"][number]
  onClose: () => void
  addressToUse?: string
  coords: number[] | null
}
